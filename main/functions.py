...
def next_generation(grid: list[list[bool]]) -> list[list[bool]]:
    """
    Calculate and return the next generation of the grid.
    Args:
      grid: The current generation of the grid.
...
def display_grid(grid: list[list[bool]], death_count: list[list[int]]) -> None:
    ...
    Args:
        grid: The current grid. 
        death_count: A grid containing the number of generations each cell has remained dead.
